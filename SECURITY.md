...
2. Report the vulnerability using one of these methods:
   - Use GitHub's [Security Advisory](https://github.com/mmustra/rxjs-poll/security/advisories/new) feature (recommended)
   - Contact the maintainer via [GitHub profile](https://github.com/mmustra) (email available on profile)
...
- Review the [changelog](https://github.com/mmustra/rxjs-poll/releases) for security-related updates
