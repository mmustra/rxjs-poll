 ...
 * @param getTime - Function that returns the delay in milliseconds before the next repetition
 * @returns Observable that repeats the source with the given delay
 */
